export default {
  route: {
    ...
    tinymce: 'Tinymce',
    markdown: 'Markdown',
    jsonEditor: 'JSON ედიტორი',
    dndList: 'Dnd სია',
    splitPane: 'SplitPane',
    avatarUpload: 'ავატარის ატვირთვა',
    dropzone: 'Dropzone',
    sticky: 'Sticky',
    countTo: 'CountTo',
    ...
    charts: 'დიაგრამები',
    keyboardChart: 'კლავიატურის დიაგრამები',
    lineChart: 'ხაზოვანი დიაგრამა',
    mixChart: 'Mix Chart',
    example: 'მაგალითი',
    nested: 'ჩადგმული როუტები',
    menu1: 'Menu 1',
    'menu1-1': 'Menu 1-1',
    'menu1-2': 'Menu 1-2',
