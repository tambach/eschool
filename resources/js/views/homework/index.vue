            ...
            <div class="card-body">
              <div id="app">
                <el-tabs type="border-card" @tab-click="getHomeWork">
                  <el-tab-pane v-for="tab in lessons" :key="tab.id" :label="tab.name">
                    <!--                                        <el-table-->
                    <!--                                            :data="tableData"-->
                    <!--                                            style="width: 70%"-->
                    <!--                                            border >-->
                    ...
                    <!--                                                    <el-row>-->
                    <!--                                                        <upload-home-work :user-id="userid" :home-work-id="homework_id" :on-success="handleSuccess" :before-upload="beforeUpload"/>-->
                    <!--                                                    </el-row>-->
                    <!--                                                </template>-->
                    <!--                                            </el-table-column>-->
                    <!--                                            <el-table-column label="შეფასება"  prop="grade" align="center"> </el-table-column>-->
                    <!--                                        </el-table>-->

                    <el-table :data="tableData" border fit highlight-current-row style="width: 100%">
                      <el-table-column align="center" label="DeadLine" prop="date" />
                      ...
                      <el-table-column align="center" label="Actions">
                        <template slot-scope="scope">
                          <router-link :to="'/homework/create/'">
                            <el-button type="primary" size="small" icon="el-icon-edit">დაამატე დავალება</el-button>
                          </router-link>
                        </template>
                      </el-table-column>
